        ...
        class Ui(QtWidgets.QMainWindow):
            def __init__(main):
                ...
                def installpackages():
                    ...
                    if main.vlc.ischecked():
                        scooppackages.append('vlc')
                    else:
                        time.sleep(0)
                    
                    if main.cider.ischecked():
                        scooppackages.append('cider')
                    else:
                        time.sleep(0)
                    
                    if main.gom.ischecked():
                        chocopackages.append('gom-player')
                    else:
                        time.sleep(0)
                    
                    if main.filmora.ischecked():
                        wingetpackages.append('Wondershare.Filmora')
                    else:
                        time.sleep(0)
                    
                    if main.tidal.ischecked():
                        chocopackages.append('tidal')
                    else:
                        time.sleep(0)
                    
                    if main.audacium.ischecked():
                        wingetpackages.append('SartoxOnlyGNU.Audacium')
                    else:
                        time.sleep(0)
                    
                    if main.mypaint.ischecked():
                        scooppackages.append('mypaint')
                    else:
                        time.sleep(0)
                    
                    if main.audacity.ischecked():
                        scooppackages.append('audacity')
                    else:
                        time.sleep(0)
                    
                    if main.deezer.ischecked():
                        chocopackages.append('deezer')
                    else:
                        time.sleep(0)

                    if main.spotify.ischecked():
                        scooppackages.append('spotify')
                    else:
                        time.sleep(0)
                    
                    if main.itunes.ischecked():
                        chocopackages.append('itunes')
                    else:
                        time.sleep(0)
                    
                    if main.clementine.ischecked():
                        scooppackages.append('clementine')
                    else:
                        time.sleep(0)
                    
                    if main.handbrake.ischecked():
                        scooppackages.append('handbrake')
                    else:
                        time.sleep(0)
                    
                    if main.kdenlive.ischecked():
                        scooppackages.append('kdenlive')
                    else:
                        time.sleep(0)
                    
                    if main.mpv.ischecked():
                        scooppackages.append('mpv')
                    else:
                        time.sleep(0)
                    
                    if main.potplayer.ischecked():
                        scooppackages.append('potplayer')
                    else:
                        time.sleep(0)
                    
                    if main.paintdotnet.ischecked():
                        scooppackages.append('paint.net')
                    else:
                        time.sleep(0)
                    
                    if main.krita.ischecked():
                        scooppackages.append('krita')
                    else:
                        time.sleep(0)
                    
                    if main.tuxpaint.ischecked():
                        chocopackages.append('tux-paint')
                    else:
                        time.sleep(0)
                    
                    if main.gimp.ischecked():
                        scooppackages.append('gimp')
                    else:
                        time.sleep(0)
                    
                    if main.glimpse.ischecked():
                        scooppackages.append('glimpse')
                    else:
                        time.sleep(0)
                    
                    if main.photogimp.ischecked():
                        chocopackages.append('photogimp')
                    else:
                        time.sleep(0)

                    if main.upscay.ischecked():
                        scooppackages.append('upscayl')
                    else:
                        time.sleep(0)

                    if main.imageglass.ischecked():
                        scooppackages.append('imageglass')
                    else:
                        time.sleep(0)
