...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.brave = customtkinter.CTkCheckBox(self.browsers_frame, text="Brave", variable=self.check_brave_browser)
        self.brave.grid(row=1, column=0, padx=20, pady=20)
        self.msedge = customtkinter.CTkCheckBox(self.browsers_frame, text="Microsoft Edge", variable=self.check_microsoft_edge)
        self.msedge.grid(row=1, column=1, padx=20, pady=20)
        self.kmeleon = customtkinter.CTkCheckBox(self.browsers_frame, text="K Meleon", variable=self.check_k_meleon)
        self.kmeleon.grid(row=1, column=2, padx=20, pady=20)
        self.chrome = customtkinter.CTkCheckBox(self.browsers_frame, text="Google Chrome", variable=self.check_google_chrome)
        ...
        self.firefox = customtkinter.CTkCheckBox(self.browsers_frame, text="Mozilla Firefox", variable=self.check_mozilla_firefox)
        ...
        self.palemoon = customtkinter.CTkCheckBox(self.browsers_frame, text="Pale Moon", variable=self.check_pale_moon)
        ...
        self.operagx = customtkinter.CTkCheckBox(self.browsers_frame, text="Opera GX", variable=self.check_opera_gx)
        ...
        self.amazongames = customtkinter.CTkCheckBox(self.games_frame, text="Amazon Games", variable=self.check_amazon_games)
        self.amazongames.grid(row=1, column=1, padx=20, pady=20)
        self.ubisoft = customtkinter.CTkCheckBox(self.games_frame, text="Ubisoft Connect", variable=self.check_ubisoft_connect)
        ...
        self.epicgames = customtkinter.CTkCheckBox(self.games_frame, text="Epic Games Launcher", variable=self.check_epic_games_launcher)
        ...
        self.heroic = customtkinter.CTkCheckBox(self.games_frame, text="Heroic Games Launcher", variable=self.check_heroic_games_launcher)
        self.heroic.grid(row=2, column=1, padx=20, pady=20)
        self.gog = customtkinter.CTkCheckBox(self.games_frame, text="GOG Galaxy", variable=self.check_gog_galaxy)
        self.gog.grid(row=2, column=2, padx=20, pady=20)
        self.itchio = customtkinter.CTkCheckBox(self.games_frame, text="Itch.IO", variable=self.check_itch_io)
        self.itchio.grid(row=2, column=3, padx=20, pady=20)
        self.minecraft = customtkinter.CTkCheckBox(self.games_frame, text="Minecraft Launcher", variable=self.check_minecraft_launcher)
        ...
        self.battlenet = customtkinter.CTkCheckBox(self.games_frame, text="Battle.net", variable=self.check_battle_net)
        ...
        self.msteams = customtkinter.CTkCheckBox(self.messaging_frame, text="Microsoft Teams", variable=self.check_microsoft_teams)
        ...
        self.sedja = customtkinter.CTkCheckBox(self.office_frame, text="Sedja PDF", variable=self.check_sedja_pdf)
        self.sedja.grid(row=1, column=0, padx=20, pady=20)
        self.sumatra = customtkinter.CTkCheckBox(self.office_frame, text="Sumatra PDF", variable=self.check_sumatra_pdf)
        self.sumatra.grid(row=1, column=1, padx=20, pady=20)
        self.adobereader = customtkinter.CTkCheckBox(self.office_frame, text="Adobe Reader", variable=self.check_adobe_reader)
        self.adobereader.grid(row=1, column=2, padx=20, pady=20)
        self.wps = customtkinter.CTkCheckBox(self.office_frame, text="WPS Office", variable=self.check_wps_office)
        ...
        self.kingsoft = customtkinter.CTkCheckBox(self.office_frame, text="Kingsoft Office", variable=self.check_kingsoft_office)
        ...
        self.msoffice = customtkinter.CTkCheckBox(self.office_frame, text="MS Office 365", variable=self.check_microsoft_office)
        ...
        self.adwcleaner = customtkinter.CTkCheckBox(self.security_frame, text="Adw Cleaner", variable=self.check_adw_cleaner)
        ...
        self.filmora = customtkinter.CTkCheckBox(self.media_frame, text="Filmora", variable=self.check_wondershare_filmora)
        ...
        self.potplayer = customtkinter.CTkCheckBox(self.media_frame, text="Pot Player", variable=self.check_pot_player)
        self.potplayer.grid(row=3, column=3, padx=20, pady=20)
        self.paintdotnet = customtkinter.CTkCheckBox(self.media_frame, text="Paint.Net", variable=self.check_paint_dot_net)
        ...
        self.notepadplus = customtkinter.CTkCheckBox(self.utils_frame, text="Notepad++", variable=self.check_notepad_plus_plus)
        ...
        self.sublime = customtkinter.CTkCheckBox(self.utils_frame, text="Sublime Text", variable=self.check_sublime_text)
        ...
        self.vscode = customtkinter.CTkCheckBox(self.utils_frame, text="VS Code", variable=self.check_visual_studio_code)
        ...
        self.sysinternals = customtkinter.CTkCheckBox(self.utils_frame, text="Sysinternals Suite", variable=self.check_sysinternals_suite)
